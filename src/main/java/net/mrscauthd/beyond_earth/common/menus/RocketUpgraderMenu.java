...
public class RocketUpgraderMenu {
    ...
    public static class GuiContainer extends AbstractContainerMenu {
        ...
        public GuiContainer(int id, Inventory inv, RocketUpgraderBlockEntity blockEntity) {
            ...
            this.addSlot(new SlotItemHandler(itemHandler, CompressorBlockEntity.SLOT_INGREDIENT, 40, 57));
            this.addSlot(new SlotItemHandler(itemHandler, CompressorBlockEntity.SLOT_INGREDIENT, 67, 57));

            this.addSlot(new SlotItemHandler(itemHandler, ItemStackToItemStackBlockEntity.SLOT_OUTPUT, 135, 57) {
                @Override
