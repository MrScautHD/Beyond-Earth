...
public class MoonOrbitSky {
    ...
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(BeyondEarthMod.MODID, "moon_orbit");

    @Nullable
    public static VertexBuffer starBuffer;
    private static final ResourceLocation MOON_TEXTURE = new ResourceLocation(BeyondEarthMod.MODID, "textures/sky/moon.png");
