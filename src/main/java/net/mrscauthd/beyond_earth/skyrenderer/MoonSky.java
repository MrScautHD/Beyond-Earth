            ...
            public ISkyRenderHandler getSkyRenderHandler() {
                return new ISkyRenderHandler() {
                    ...
                    public void render(int ticks, float p_181412_, PoseStack p_181410_, ClientLevel level, Minecraft minecraft) {
                        ...
                        bufferbuilder.vertex(matrix4f1, 25, -100.0F, 25).uv(1.0F, 0.0F).endVertex();
                        bufferbuilder.vertex(matrix4f1, 25, -100.0F, -25).uv(1.0F, 1.0F).endVertex();
                        bufferbuilder.vertex(matrix4f1, -25, -100.0F, -25).uv(0.0F, 1.0F).endVertex();
                        bufferbuilder.end();
                        BufferUploader.end(bufferbuilder);
                        ...
                        bufferbuilder.vertex(matrix4f1, 9, -99.0F, 9).uv(1.0F, 0.0F).endVertex();
                        bufferbuilder.vertex(matrix4f1, 9, -99.0F, -9).uv(1.0F, 1.0F).endVertex();
                        bufferbuilder.vertex(matrix4f1, -9, -99.0F, -9).uv(0.0F, 1.0F).endVertex();
                        bufferbuilder.end();
                        BufferUploader.end(bufferbuilder);
