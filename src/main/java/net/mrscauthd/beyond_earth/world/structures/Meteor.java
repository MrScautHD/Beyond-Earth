...
public class Meteor extends StructureFeature<JigsawConfiguration> {

    public Meteor() {
        super(JigsawConfigurator.CODEC, Meteor::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
