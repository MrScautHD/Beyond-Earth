...
public class PygroTower extends Structure {
    ...
    public static final Codec<PygroTower> CODEC = RecordCodecBuilder.<PygroTower>mapCodec(instance ->
            instance.group(PygroTower.settingsCodec(instance),
            ...
            ).apply(instance, PygroTower::new)).codec();

    public PygroTower(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter) {
        super(config);
    ...
    public StructureType<?> type() {
        return StructuresRegistry.PYGRO_TOWER.get();
    }
}
