...
public class PygroTower extends StructureFeature<JigsawConfiguration> {

    public PygroTower() {
        super(JigsawConfigurator.CODEC, PygroTower::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
