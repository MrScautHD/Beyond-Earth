...
public class PygroVillage extends StructureFeature<JigsawConfiguration> {

    public PygroVillage() {
        super(JigsawConfigurator.CODEC, PygroVillage::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
