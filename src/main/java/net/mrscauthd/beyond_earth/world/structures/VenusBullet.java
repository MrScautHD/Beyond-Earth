...
public class VenusBullet extends StructureFeature<JigsawConfiguration> {

    public VenusBullet() {
        super(JigsawConfigurator.CODEC, VenusBullet::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
