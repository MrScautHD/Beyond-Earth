...
public class OilWell extends Structure {
    ...
    public static final Codec<OilWell> CODEC = RecordCodecBuilder.<OilWell>mapCodec(instance ->
            instance.group(OilWell.settingsCodec(instance),
            ...
            ).apply(instance, OilWell::new)).codec();

    public OilWell(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter) {
        super(config);
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        ChunkPos chunkPos = context.chunkPos();
        BlockPos blockPos = new BlockPos(chunkPos.getMinBlockX(), startY - 10, chunkPos.getMinBlockZ());
    ...
    public StructureType<?> type() {
        return StructuresRegistry.OIL_WELL.get();
    }
}
