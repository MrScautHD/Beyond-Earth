...
public class OilWell extends StructureFeature<JigsawConfiguration> {

    public OilWell() {
        super(JigsawConfigurator.CODEC, OilWell::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
