...
public class AlienVillage extends StructureFeature<JigsawConfiguration> {

    public AlienVillage() {
        super(JigsawConfigurator.CODEC, AlienVillage::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
