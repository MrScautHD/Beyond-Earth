...
public class AlienVillage extends Structure {
    ...
    public static final Codec<AlienVillage> CODEC = RecordCodecBuilder.<AlienVillage>mapCodec(instance ->
            instance.group(AlienVillage.settingsCodec(instance),
            ...
            ).apply(instance, AlienVillage::new)).codec();

    public AlienVillage(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter) {
        super(config);
    ...
    public StructureType<?> type() {
        return StructuresRegistry.ALIEN_VILLAGE.get();
    }
}
