...
public class PlanetSelectionGuiWindow extends AbstractContainerScreen<PlanetSelectionGui.GuiContainer> {
	...
	protected void init() {
		...
		/** SPACE STATION BUTTONS */
		// CATEGORY 0
		earthSpaceStationButton = this.addSpaceStationImageButton(125, (this.height / 2) - 24 / 2, 75, 20, brbButtonTex, Methods.overworld_orbit, tl("space_station"), this.spaceStationItemList);
		earthSpaceStationButton.visible = false;

		moonSpaceStationButton = this.addSpaceStationImageButton(125, (this.height / 2) + 21 / 2, 75, 20, brbButtonTex, Methods.moon_orbit, tl("space_station"), this.spaceStationItemList);
		moonSpaceStationButton.visible = false;

		marsSpaceStationButton = this.addSpaceStationImageButton(125, (this.height / 2) - 24 / 2, 75, 20, brbButtonTex, Methods.mars_orbit, tl("space_station"), this.spaceStationItemList);
		marsSpaceStationButton.visible = false;

		mercurySpaceStationButton = this.addSpaceStationImageButton(125, (this.height / 2) - 24 / 2, 75, 20, brbButtonTex, Methods.mercury_orbit, tl("space_station"), this.spaceStationItemList);
		mercurySpaceStationButton.visible = false;

		venusSpaceStationButton = this.addSpaceStationImageButton(125, (this.height / 2) - 24 / 2, 75, 20, brbButtonTex, Methods.venus_orbit, tl("space_station"), this.spaceStationItemList);
		venusSpaceStationButton.visible = false;
		// CATEGORY 5
		glacioSpaceStationButton = this.addSpaceStationImageButton(125, (this.height / 2) - 24 / 2, 75, 20, brbButtonTex, Methods.glacio_orbit, tl("space_station"), this.spaceStationItemList);
		glacioSpaceStationButton.visible = false;
	}
