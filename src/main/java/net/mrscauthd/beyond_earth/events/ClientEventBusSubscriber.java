...
import net.mrscauthd.beyond_earth.renderers.TileEntityBoxRenderer;
import net.mrscauthd.beyond_earth.renderers.alien.AlienModel;
import net.mrscauthd.beyond_earth.renderers.alienzombie.AlienZombieModel;
import net.mrscauthd.beyond_earth.renderers.alienzombie.AlienZombieRenderer;
import net.mrscauthd.beyond_earth.renderers.armors.JetSuitModel;
import net.mrscauthd.beyond_earth.renderers.flag.TileEntityHeadModel;
import net.mrscauthd.beyond_earth.renderers.flag.TileEntityHeadRenderer;
import net.mrscauthd.beyond_earth.renderers.globe.GlobeBlockRenderer;
import net.mrscauthd.beyond_earth.renderers.globe.GlobeModel;
import net.mrscauthd.beyond_earth.renderers.lander.LanderModel;
import net.mrscauthd.beyond_earth.renderers.lander.LanderRenderer;
import net.mrscauthd.beyond_earth.renderers.martianraptor.MartianRaptorModel;
import net.mrscauthd.beyond_earth.renderers.martianraptor.MartianRaptorRenderer;
import net.mrscauthd.beyond_earth.renderers.mogler.MoglerModel;
import net.mrscauthd.beyond_earth.renderers.mogler.MoglerRenderer;
import net.mrscauthd.beyond_earth.renderers.pygro.PygroModel;
import net.mrscauthd.beyond_earth.renderers.pygro.PygroRenderer;
import net.mrscauthd.beyond_earth.renderers.pygrobrute.PygroBruteRenderer;
import net.mrscauthd.beyond_earth.renderers.rockettier1.RocketTier1ItemRenderer;
import net.mrscauthd.beyond_earth.renderers.rockettier1.RocketTier1Model;
import net.mrscauthd.beyond_earth.renderers.rockettier1.RocketTier1Renderer;
import net.mrscauthd.beyond_earth.renderers.rockettier2.RocketTier2ItemRenderer;
import net.mrscauthd.beyond_earth.renderers.rockettier2.RocketTier2Model;
import net.mrscauthd.beyond_earth.renderers.rockettier2.RocketTier2Renderer;
import net.mrscauthd.beyond_earth.renderers.rockettier3.RocketTier3ItemRenderer;
import net.mrscauthd.beyond_earth.renderers.rockettier3.RocketTier3Model;
import net.mrscauthd.beyond_earth.renderers.rockettier3.RocketTier3Renderer;
import net.mrscauthd.beyond_earth.renderers.rockettier4.RocketTier4ItemRenderer;
import net.mrscauthd.beyond_earth.renderers.rockettier4.RocketTier4Model;
import net.mrscauthd.beyond_earth.renderers.rockettier4.RocketTier4Renderer;
import net.mrscauthd.beyond_earth.renderers.rover.RoverItemRenderer;
import net.mrscauthd.beyond_earth.renderers.rover.RoverModel;
import net.mrscauthd.beyond_earth.renderers.rover.RoverRenderer;
import net.mrscauthd.beyond_earth.renderers.armors.SpaceSuitModel;
import net.mrscauthd.beyond_earth.renderers.starcrawler.StarCrawlerModel;
import net.mrscauthd.beyond_earth.renderers.starcrawler.StarCrawlerRenderer;
...
import net.mrscauthd.beyond_earth.renderers.alien.AlienRenderer;
