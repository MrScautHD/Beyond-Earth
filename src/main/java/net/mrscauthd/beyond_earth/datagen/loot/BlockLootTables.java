...
public class BlockLootTables extends BlockLoot {
    ...
    protected void addTables() {
        ...
        this.dropSelf(BlockRegistry.FLAG_BLUE_BLOCK.get());
        this.dropSelf(BlockRegistry.FLAG_BROWN_BLOCK.get());
        this.dropSelf(BlockRegistry.FLAG_CYAN_BLOCK.get());
        this.dropSelf(BlockRegistry.FLAG_GRAY_BLOCK.get());
        this.dropSelf(BlockRegistry.FLAG_GREEN_BLOCK.get());
        this.dropSelf(BlockRegistry.FLAG_LIGHT_BLUE_BLOCK.get());
        this.dropSelf(BlockRegistry.FLAG_LIME_BLOCK.get());
        this.dropSelf(BlockRegistry.FLAG_MAGENTA_BLOCk.get());
        this.dropSelf(BlockRegistry.FLAG_ORANGE_BLOCK.get());
        this.dropSelf(BlockRegistry.FLAG_PINK_BLOCK.get());
        ...
        this.dropSelf(BlockRegistry.RUSTED_IRON_PILLAR_BLOCK.get());
        this.dropSelf(BlockRegistry.RUSTED_IRON_PLATING_BLOCK.get());
        this.dropSelf(BlockRegistry.BLUE_IRON_PLATING_BLOCK.get());
        this.dropSelf(BlockRegistry.IRON_MARK_BLOCK.get());
        this.dropSelf(BlockRegistry.SKY_STONE.get());
        this.dropSelf(BlockRegistry.INFERNAL_SPIRE_BLOCK.get());
