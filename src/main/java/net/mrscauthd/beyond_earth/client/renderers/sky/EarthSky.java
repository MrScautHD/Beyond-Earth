    ...
    public boolean renderSky(ClientLevel level, int ticks, float partialTick, PoseStack poseStack, Camera camera, Matrix4f projectionMatrix, boolean isFoggy, Runnable setupFog) {
        ...
        if (!isFoggy) {
            ...
            if (fogtype != FogType.POWDER_SNOW && fogtype != FogType.LAVA && !mc.levelRenderer.doesMobEffectBlockSky(camera)) {
                ...
                SkyHelper.drawSunWithLightAndSatellites(mc, SkyHelper.SUN, new Vec3(242, 204,92),  new Vec3(244, 220, 85), new Vec3(210, 210, 210), bufferBuilder, matrix4f, 5F, 5F * 4F, 1.0F, 15, 60F, 30F, 30F, 2F, 100F, false, false);
