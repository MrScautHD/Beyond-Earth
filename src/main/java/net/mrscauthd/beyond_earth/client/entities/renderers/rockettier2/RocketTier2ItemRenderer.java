package net.mrscauthd.beyond_earth.client.entities.renderers.rockettier2;
...
public class RocketTier2ItemRenderer<T extends RocketTier2Entity> extends BlockEntityWithoutLevelRenderer {
    ...
    public RocketTier2ItemRenderer(BlockEntityRenderDispatcher p_172550_, EntityModelSet p_172551_) {
    ...
    public void renderByItem(ItemStack p_108830_, ItemTransforms.TransformType p_108831_, PoseStack matrixStackIn, MultiBufferSource buffer, int combinedLight, int p_108835_) {
        ...
        if (this.model == null) {
            this.model = new RocketTier2Model(mc.getEntityModels().bakeLayer(RocketTier2Model.LAYER_LOCATION));
        }
