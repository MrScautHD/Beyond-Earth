package net.mrscauthd.beyond_earth.client.entities.renderers.martianraptor;
...
public class MartianRaptorModel<T extends MartianRaptor> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BeyondEarth.MODID, "martian_raptor"), "main");
